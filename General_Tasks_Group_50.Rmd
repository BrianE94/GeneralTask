...
Furthermore, external access from other users perspective is not possible/doable, no application could be run on other devices/computers.

The amount of data combined with the analysis based data requires a lot of memory capacity. Local computers (depending on the hardware) might not be able to process it.
